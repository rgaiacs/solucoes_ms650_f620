...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}[scale=.3]
    % Eixos
    \draw[->] (-5 * 3.14,0) -- (5 * 3.14, 0) node[below right] {$x$};
    \draw[->] (0,-.5) -- (0, 3.5 * 3.14) node[above right] {$y$};
    \foreach \x in {-4,...,4}{
      \draw (\x * 3.14,0) node[below] {$\x \pi$};
    }

    % Gráfico de $x^2$
    \draw[color=red, domain=-3.14:3.14] plot (\x,\x * \x) node[right] {$f(x) =
    x^2$};
    \draw[color=blue, domain=-3.14:3.14] plot (\x + 2 * 3.14,\x * \x);
    \draw[color=blue, domain=-3.14:3.14] plot (\x + 4 * 3.14,\x * \x);
    \draw[color=blue, domain=-3.14:3.14] plot (\x - 2 * 3.14,\x * \x);
    \draw[color=blue, domain=-3.14:3.14] plot (\x - 4 * 3.14,\x * \x);
  \end{tikzpicture}
  \caption{Gráfico de $f(x) = x^2$, em vermelho, no intervalo $[-\pi,+\pi]$ e da
  extensão periórica de $f(x)$, em azul.}
  \label{fig:serie_fourier_grafico01}
\end{figure}

\begin{exem} \label{exem:fourier2}
  Para
  \begin{dmath*}
    f(x) = \begin{cases}
      -1, & x < 0, \\
...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}[xscale=.5]
    % Eixos
    \draw[->] (-3 * 3.14,0) -- (3 * 3.14, 0) node[below right] {$x$};
    ...
    % Gráfico
    \draw[color=red] (0,1) circle (.1) -- +(3.14,0) circle(.1);
    \draw[color=red] (0,-1) circle (.1) -- +(-3.14,0) circle(.1);
    \draw[color=red, fill] (0,0) circle (.1);
    \draw[color=blue] (2 * 3.14,1) circle (.1) -- +(3.14,0) circle(.1);
    \draw[color=blue] (2 * 3.14,-1) circle (.1) -- +(-3.14,0) circle(.1);
    \draw[color=blue, fill] (1 * 3.14,0) circle (.1);
    \draw[color=blue, fill] (2 * 3.14,0) circle (.1);
    \draw[color=blue] (-2 * 3.14,1) circle (.1) -- +(3.14,0) circle(.1);
    \draw[color=blue] (-2 * 3.14,-1) circle (.1) -- +(-3.14,0) circle(.1);
    \draw[color=blue, fill] (-1 * 3.14,0) circle (.1);
    \draw[color=blue, fill] (-2 * 3.14,0) circle (.1);
  \end{tikzpicture}
  \caption{Gráfico da série de Fourier para $f(x)$ do
  Exemplo~\ref{exem:fourier2}}
