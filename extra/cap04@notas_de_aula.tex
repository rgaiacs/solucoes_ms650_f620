...
\begin{dgroup*}
  ...
  \end{dmath*}
\end{dgroup*}
onde o uso da notação no caso da variável $K$ se justifica graças à identidade
...
A interpretação do teorema anterior é que
\begin{enumerate}
...
\end{dmath*}
Escolhendo $N$ de modo que $\| f \|^2 = 1$, ou seja, $N = \left( 2 \alpha / \pi
...
\begin{dmath*}
  ...
  \end{bmatrix}
\end{dmath*}
onde $I_{N_1}$ é a matriz identidade de ordem $N_1$, podemos escrever
\begin{dmath*}
  \begin{bmatrix}
    F_{+} \\
    0
